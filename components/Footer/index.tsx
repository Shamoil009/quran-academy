...
const Footer = ({ className }: Props) => {
  return (
    <footer className="flex bg-courseBgColor px-5 py-12 text-FooterColor lg:justify-center lg:px-0 2xl:pb-20 2xl:pt-16">
      <div className="flex flex-col justify-between text-sm lg:w-[90%] lg:flex-row 2xl:w-[90%] 2xl:text-base">
        <section className="w-[25%] space-y-2 2xl:space-y-4">
          ...
          <div className="flex space-x-5 pt-2">
            ...
            {/* <Image src={Instagram} height={20} width={20} alt="" />
              <Image src={Twitter} height={20} width={20} alt="" />
              <Image src={Linkedin} height={20} width={20} alt="" />
              <Image src={Youtube} height={20} width={20} alt="" /> */}
          </div>
        </section>
        <section>
        ...
        <section className="pt-7 lg:pt-0">
          ...
          <div className="space-y-2 pt-2 tracking-wide lg:pt-4 2xl:space-y-4 2xl:pt-7 2xl:tracking-wider">
            <div className="flex items-center gap-2">
              <FontAwesomeIcon icon={faEnvelope} className="w-4 text-secondaryColor lg:w-5"/>
              Aqquranacademy.org@gmail.com
            </div>
            <div className="flex items-center gap-2">
              <FontAwesomeIcon icon={faPhone} className="w-4 text-secondaryColor lg:w-5"/>
              +92 348 154 8861
            </div>
            <div className="flex items-center gap-2">
              <FontAwesomeIcon icon={faWhatsapp} className="w-4 text-secondaryColor lg:w-5"/>
              +1 202 773 5409
            </div>
            <div className="flex items-start gap-2">
              <FontAwesomeIcon icon={faMap} className="mt-1 w-4 text-secondaryColor lg:w-5"/>
              <div className="w-[50%] lg:w-72">Office No. 09, Al.imran Plaza Near Umania Restaurant Dhok Jelani,
              Bhara Kahu, Islamabad, Pakistan</div>
            </div>
          </div>
        </section>
      </div>
